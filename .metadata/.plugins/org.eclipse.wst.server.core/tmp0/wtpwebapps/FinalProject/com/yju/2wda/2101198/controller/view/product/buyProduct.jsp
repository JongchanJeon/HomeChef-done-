...
%>
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control"  min="1" max="11099999999" placeholder="전화번호를 입력하세요. ex) 01012349876" aria-label="Username"
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="주소를 입력하세요" aria-label="Username"
         	...
         	<!-- 구매하기 버튼 비활성화 되 -->
         	<button class="btn btn-primary" onclick="nono()">결제하기</button>
         	</form>
